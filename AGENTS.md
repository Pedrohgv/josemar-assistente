...
- `obsidian-vault`: notes/attachments; TaskNotes MCP deployments require server-local Git history that is excluded from Syncthing and unrelated to agent-state sync
