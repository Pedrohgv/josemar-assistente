...
6. **No nested wrapper usage in TaskNotes.** TaskNotes remains a bounded MCP
   ...
   filesystem exception (issue #139, default off) is its own derived Daily
   ...
   under the same lock. It retains its transaction-level global lock and
